(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["LarkMatter"] = factory(require("matter-js"));
	else
		root["LarkMatter"] = factory(root["matter-js"]);
...
function renderLm(render) {
    ...
    bodies.forEach(function (body) {
      ...
      exports.context.translate(x, y)
      exports.context.rotate(2*ri*Math.PI/exports.LarkMatter.options.rotationNum)

      body.pixels.forEach(function (p) {
            o.x = p.x;
            o.y = p.y;
            // o = matter.Vector.rotate(o, angle);
            pag.draw(exports.context, p.pattern, o.x, o.y, ri);
        });
...
/***/ function(module, exports) {
	...
	exports.Pixel = Pixel;
	function draw(context, pixels, x, y, rotationIndex, angle) {
	    if (rotationIndex === void 0) { rotationIndex = 0; }
	    var pxs = pixels[rotationIndex % pixels.length];
	    var pw = pxs.length;
	    var ph = pxs[0].length;
